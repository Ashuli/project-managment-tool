<template>
  <div
    ...
    v-clickOutside="deactivateDropdown"
  >
    <div
    ...
    >
      ...
      <div v-if="!isValueEmpty && isMulti" class="valueMulti text-textDarkest">
          ...
          <div v-else class="valueMultiItem text-textDarkest">
            ...
            >
              <svg class="icon" viewBox="0 0 24 24">
                <path
                  d="M16.192 6.344L11.949 10.586 7.707 6.344
                   6.293 7.758 10.535 12 6.293 16.242 7.707
                    17.656 11.949 13.414 16.192 17.656 17.606
                     16.242 13.364 12 17.606 7.758z"
                />
              </svg>
            </div>
          </div>
        ...
        <div class="addMore m-1">
          ...
          >
            <path
              d="M13 11V3.993A.997.997 0 0 0 12 3c-.556 0-1 .445-1
               .993V11H3.993A.997.997 0 0 0 3 12c0 .557.445 1 .993
                1H11v7.007c0 .548.448.993 1 .993.556 0 1-.445
                 1-.993V13h7.007A.997.997 0 0 0 21 12c0-.556-.445-1-.993-1H13z"
              fill="currentColor"
              fill-rule="evenodd"
            ></path>
          </svg>
...
<script>
import clickOutside from '@/hooks/outsideClick'
...
export default {
  ...
  data() {
    return {
      ...
      stateValue: this.defaultValue || (this.isMulti ? [] : null),
      searchValue: '',
      dropdownRef: '',
    }
  },
  computed: {
    ...
    isValueEmpty() {
      return this.isMulti
        ...
        : !this.getOption(this.localValue)
    },
    localValue() {
  ...
  methods: {
    ...
    handleChange(newValue) {
      ...
      this.$emit('change', this.preserveValueType(newValue))
    },
    ...
    async deactivateDropdown() {
      ...
      this.$refs.selectRef.value && this.$refs.selectRef.value.focus()
    },
    async activateDropdown() {
      ...
      this.searchable && this.$refs.dropdownRef.$refs.inputRef.focus()
    },
    getOption(optionValue) {
